...
# Build all once as this will still build for all runtimes. Ignore warning that some runtimes are EOL and contain known vulnerabilities
dotnet build -c release -v q --nowarn:NU1903 --nowarn:NU1902 --nowarn:NETSDK1138
